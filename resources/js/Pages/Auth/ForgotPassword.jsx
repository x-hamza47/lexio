    ...
    return (
        <div className="text-white d-center py-9 h-dvh select-none">
            <div className="w-lg px-8 py-6 bg-black/5  backdrop-blur-md border border-white/20 shadow-lg rounded-2xl">
                <button className="absolute bg-white/5 border border-white/10 shadow-md text-gray-500 hover:text-white/80 w-10 h-10 d-center rounded-full  hover:bg-white/10 hover:shadow-xl active:scale-90 active:shadow-inner transition duration-200 ease-in-out cursor-pointer"
